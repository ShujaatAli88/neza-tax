...
export const ABOUT_CONTENT = {
  ...
  intro: [
    ...
    "Through Neza Tax Services, we provide individual and business tax preparation along with year-round tax support. Our Business Services help business owners with bookkeeping, payroll, business formation, business compliance, and other ongoing needs.",
    "We also help individuals, families, and businesses explore life, health, dental and vision insurance, employee benefits, Medicare, and retirement solutions. For clients purchasing, refinancing, or investing in real estate, Jose Gonzalez provides mortgage loan origination services through C2 Financial Corporation.",
  ],
  ...
  approach: {
    ...
    paragraphs: [
      ...
      "Whether you need help with your taxes, are running a business, exploring insurance or retirement solutions, or financing real estate, we want Neza Financial Group to be a trusted resource as your needs evolve.",
    ],
  },
  ...
  founder: {
    ...
    paragraphs: [
      "Jose Gonzalez works with individuals, families, and business owners across tax services, business services, insurance and retirement solutions, and mortgage lending.",
  ...
  helpItems: [
    {
      title: "Tax Services",
      body: "Individual and business tax preparation, ITIN assistance, amended and prior-year returns, and year-round support.",
    ...
    },
    {
      ...
      body: "Bookkeeping, payroll, business formation, compliance, and ongoing business support.",
    ...
    },
    {
      ...
      body: "Insurance, employee benefits, Medicare, and retirement solutions for individuals, families, and businesses.",
    ...
    },
    {
      ...
      body: "Home purchase, refinance, and investment property financing through C2 Financial Corporation.",
